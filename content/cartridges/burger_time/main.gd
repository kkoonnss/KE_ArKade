...
func _draw_hud():
    ...
    if game_id == "burger_time" and game_state == "start":
        var center = get_viewport_rect().size * 0.5
        draw_rect(Rect2(center - Vector2(360, 190), Vector2(720, 380)), Color(0, 0, 0, 0.82), true)
        draw_rect(Rect2(center - Vector2(360, 190), Vector2(720, 380)), NEON_CYAN, false, 2.0)
        draw_string(font, center + Vector2(0, -120), "BURGER TIME", HORIZONTAL_ALIGNMENT_CENTER, -1, 42, Color.WHITE)
        draw_string(font, center + Vector2(0, -66), "WALK THE INGREDIENTS DOWN BEFORE THE FOOD CHASES YOU", HORIZONTAL_ALIGNMENT_CENTER, -1, 20, NEON_YELLOW)
        draw_string(font, center + Vector2(0, -22), "ARROWS/WASD MOVE  SPACE PEPPER  TAB SETTINGS", HORIZONTAL_ALIGNMENT_CENTER, -1, 20, NEON_CYAN)
        draw_string(font, center + Vector2(0, 22), "PLAYERS CAN JOIN HERE BEFORE START", HORIZONTAL_ALIGNMENT_CENTER, -1, 20, NEON_GREEN)
        draw_string(font, center + Vector2(0, 86), "PRESS ENTER OR SPACE TO START", HORIZONTAL_ALIGNMENT_CENTER, -1, 28, NEON_MAGENTA)
        return
    if paused:
